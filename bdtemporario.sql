...
-- Copiando estrutura do banco de dados para blogdaia
CREATE DATABASE IF NOT EXISTS `blogdaia` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `blogdaia`;

-- Copiando estrutura para tabela blogdaia.bloginfo
...
-- Copiando dados para a tabela blogdaia.bloginfo: ~9 rows (aproximadamente)
...
-- Copiando estrutura para tabela blogdaia.imagens
...
-- Copiando dados para a tabela blogdaia.imagens: ~34 rows (aproximadamente)
DELETE FROM `imagens`;
...
-- Copiando estrutura para tabela blogdaia.posts
...
-- Copiando dados para a tabela blogdaia.posts: ~0 rows (aproximadamente)
DELETE FROM `posts`;
...
-- Copiando estrutura para tabela blogdaia.usuario
...
-- Copiando dados para a tabela blogdaia.usuario: ~0 rows (aproximadamente)
DELETE FROM `usuario`;
